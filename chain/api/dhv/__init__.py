...
class DhvChainReader(ChainReader):
    ...
    def spread_param_data(self) -> SpreadParams:
        ...
        """ TODO Delte this string when happy
        Delta Spread Config Order:
    ...
    def position_data(self):
        """TODO Delete This solidity stuff when done
        struct OptionExpirationDrill {
		uint64 expiration;0
		uint128[] callStrikes;1
		OptionStrikeDrill[] callOptionDrill;2
		uint128[] putStrikes;3
		OptionStrikeDrill[] putOptionDrill;4
		uint256 underlyingPrice;5
	    }
    ...
    def collat_param_data(self, is_USDC_collatortal: bool = False):
        """TODO this can probably be deleted
        actual testnet addresses:
        from web3 import Web3
        WETH_ADDRESS = Web3.to_checksum_address(r"0x53320bE2A35649E9B2a0f244f9E9474929d3B699")
        USDC_ADDRESS = Web3.to_checksum_address(r"0x6775842ae82bf2f0f987b10526768ad89d79536e")"""
        ...
        collat = USDC_ADDRESS if is_USDC_collatortal else WETH_ADDRESS
